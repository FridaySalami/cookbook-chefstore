...
function _page($$payload, $$props) {
  ...
  $$payload.out += `<div class="container mx-auto px-4 pt-4 pb-4 md:px-6 lg:pt-6 lg:pb-6"><main class="flex-grow pt-2 pb-4 lg:pt-3 lg:pb-6">`;
