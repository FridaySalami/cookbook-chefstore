...
function _layout($$payload, $$props) {
  ...
  head($$payload, ($$payload2) => {
    ...
    $$payload2.out += `<meta name="description" content="Delicious recipes from the Chefstore team."> <meta property="og:type" content="website"> <meta property="og:site_name" content="Chefstore Cookbook"> <meta property="og:image" content="/default-og-image.png"> <meta name="twitter:card" content="summary_large_image">`;
  });
