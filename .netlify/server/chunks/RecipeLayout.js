...
function RecipeLayout($$payload, $$props) {
  ...
  $$payload.out += `<article class="recipe-article mx-auto max-w-3xl svelte-15vvm21">`;
  if (image) {
    $$payload.out += "<!--[-->";
  ...
  $$payload.out += `<!--]--> <header class="mb-8 svelte-15vvm21"><h1 class="mb-4 text-3xl leading-tight font-bold lg:text-4xl svelte-15vvm21">${escape_html(title)}</h1> `;
  if (description) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<p class="text-muted-foreground mb-6 text-lg svelte-15vvm21">${escape_html(description)}</p>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--> <div class="flex flex-wrap items-center gap-x-6 gap-y-2 svelte-15vvm21">`;
  if (prepTime !== null || cookTime !== null || totalTime !== null) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div class="flex items-center gap-2 svelte-15vvm21">`;
    Clock($$payload, { class: "h-5 w-5 text-amber-600" });
    $$payload.out += `<!----> <div class="text-sm svelte-15vvm21">`;
    if (totalTime !== null) {
      $$payload.out += "<!--[-->";
  ...
  if (servings !== null) {
    ...
    $$payload.out += `<!----> <div class="text-sm svelte-15vvm21"><strong>Serves:</strong> ${escape_html(servings)}</div></div>`;
  } else {
    $$payload.out += "<!--[!-->";
  }
  $$payload.out += `<!--]--> `;
  ...
  if (tags && tags.length > 0) {
    ...
    $$payload.out += `<div class="mt-8 flex flex-wrap gap-2 border-t pt-6 svelte-15vvm21"><!--[-->`;
